...
export default function KabutenHomepage() {
  ...
  const getSearchResults = () => {
    ...
    return { companies: matchingCompanies, themes: themeResults };
  };

  const searchResults = getSearchResults();
  const hasResults = searchResults.companies?.length > 0 || searchResults.themes?.length > 0;
      ...
      <div className="flex flex-col items-center pt-12 pb-6 px-4">
        ...
        <div className="w-full max-w-xl mb-4 relative">
          <input
            ...
            placeholder="Search by code, name, or theme..."
        ...
        <div className="flex gap-2 text-xs text-gray-400">
          ...
          <span>•</span>
          <a href="/company/6758" className="text-blue-600 cursor-pointer hover:underline">6758</a>
        </div>
      </div>
